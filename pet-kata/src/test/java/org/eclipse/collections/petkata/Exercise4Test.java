...
public class Exercise4Test extends PetDomainForKata
{
    ...
    public void streamsToECRefactor1()
    {
        //find Bob Smith
        Person person =
                this.people.select(each -> each.named("Bob Smith")).getFirst();
    ...
    public void streamsToECRefactor3()
    {
        ...
        MutableList<ObjectIntPair<PetType>> favs =
                this.people
                        .flatCollect(Person::getPets)
                        .countBy(Pet::getType)
                        .topOccurrences(3);
        ...
        Verify.assertSize(3, favs);
        Verify.assertContains(PrimitiveTuples.pair(PetType.CAT, 2), favs);
        Verify.assertContains(PrimitiveTuples.pair(PetType.DOG, 2), favs);
        Verify.assertContains(PrimitiveTuples.pair(PetType.HAMSTER, 2), favs);
